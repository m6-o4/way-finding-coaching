		...
		<section className="pt-24 pb-24">
			<Container>
				...
				<div className="mx-auto max-w-5xl py-5">
					...
					<h1 className="font-heading text-foreground mb-6 text-4xl leading-tight font-semibold text-balance md:text-5xl">
						{title}
					</h1>
					...
					<div className="border-card-border bg-card relative mb-12 aspect-video w-full overflow-hidden rounded-lg border">
						<Image
							src={imageSrc}
							alt={imageAlt}
							fill
